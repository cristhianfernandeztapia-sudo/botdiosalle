...
async def telegram_webhook(request: Request):
    ...
    try:
        ...
        async with httpx.AsyncClient() as async_client:
            await async_client.post(SEND_MSG_URL, json={"chat_id": chat_id, "text": reply})
        ...
        async with httpx.AsyncClient() as async_client:
            await async_client.post(SEND_MSG_URL, json={"chat_id": chat_id, "text": "Ups… hubo un error generando la respuesta 😔"})
    return {"ok": True}